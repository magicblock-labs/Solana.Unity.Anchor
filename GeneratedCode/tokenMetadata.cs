...
namespace MplTokenMetadata
{
    ...
    namespace Errors
    {
        public enum MplTokenMetadataErrorKind : uint
        {
            ...
            NotAPrintEdition = 116U,
            InvalidMasterEdition = 117U,
            InvalidPrintEdition = 118U,
            InvalidEditionMarker = 119U,
            ReservationListDeprecated = 120U,
            PrintEditionDoesNotMatchMasterEdition = 121U,
            EditionNumberGreaterThanMaxSupply = 122U,
            MustUnverify = 123U
        }
    }
    ...
    namespace Program
    {
        ...
        public class BurnEditionNftAccounts
        {
            public PublicKey Metadata { get; set; }

            public PublicKey Owner { get; set; }

            public PublicKey PrintEditionMint { get; set; }

            public PublicKey MasterEditionMint { get; set; }

            public PublicKey PrintEditionTokenAccount { get; set; }

            public PublicKey MasterEditionTokenAccount { get; set; }

            public PublicKey MasterEditionAccount { get; set; }

            public PublicKey PrintEditionAccount { get; set; }

            public PublicKey EditionMarkerAccount { get; set; }
        ...
        public static class MplTokenMetadataProgram
        {
            ...
            public static Solana.Unity.Rpc.Models.TransactionInstruction BurnEditionNft(BurnEditionNftAccounts accounts, PublicKey programId)
            {
                List<Solana.Unity.Rpc.Models.AccountMeta> keys = new()
                {Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.Metadata, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.Owner, true), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.PrintEditionMint, false), Solana.Unity.Rpc.Models.AccountMeta.ReadOnly(accounts.MasterEditionMint, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.PrintEditionTokenAccount, false), Solana.Unity.Rpc.Models.AccountMeta.ReadOnly(accounts.MasterEditionTokenAccount, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.MasterEditionAccount, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.PrintEditionAccount, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.EditionMarkerAccount, false), Solana.Unity.Rpc.Models.AccountMeta.ReadOnly(accounts.SplTokenProgram, false)};
                byte[] _data = new byte[1200];
                int offset = 0;
                _data.WriteU64(14221553590581094877UL, offset);
                offset += 8;
                byte[] resultData = new byte[offset];
                Array.Copy(_data, resultData, offset);
                return new Solana.Unity.Rpc.Models.TransactionInstruction{Keys = keys, ProgramId = programId.KeyBytes, Data = resultData};
